...
RUN apk add --no-cache libc6-compat curl tzdata icu-libs
...
RUN dotnet publish DotnetApiCra.csproj --output /app/publish --configuration Release --runtime linux-musl-x64
